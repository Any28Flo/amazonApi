...
def main():
    ...
    for id_ in args.ids:
        ...
        # urlPart2 = "ref=cm_cr_dp_d_show_all_top?ie=UTF8&reviewerType=all_reviews"
        ...
        refer = "https://www.amazon.com.mx/Casio-A159WGEA-1VT-Reloj-Digital-Cuadrado/product-reviews/B01ETJR0HI/ref=cm_cr_dp_d_show_all_top?ie=UTF8&reviewerType=all_reviews"
        page = 1
        lastPage = 1
        while page <= lastPage:
            ...
            url = "https://www.amazon.com.mx/Casio-A159WGEA-1VT-Reloj-Digital-Cuadrado/product-reviews/B01ETJR0HI/ref=cm_cr_dp_d_show_all_top?ie=UTF8&reviewerType=all_reviews"
            print(url)
            htmlpage, code = download_page(url, args.maxretries, args.timeout, args.pause)
